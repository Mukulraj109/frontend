        ...
        <AnimationWrapper>
            {
                loading ? <Loader/>
                :
                <BlogContext.Provider value={{blog, setBlog,isLikedByUser,setLikedByUser,setCommentsWrapper,commentsWrapper,totalParentCommentsLoaded,setTotalParentCommentsLoaded}}>
                ...
                <div className="max-w-[900px] center py-10 max-lg:px-[5vw]">
                    ...
                    <div className="my-12 font-delasio blog-page-content">
                        {
