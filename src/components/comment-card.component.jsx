...
const CommentCard = ({index , leftVal, commentData})=>{
    ...
    let [isReplying, setReplying] = useState();
    ...
    const handelReply = ()=>{
        //handle reply logic
        if(!access_token){
            return  toast.error("login first to leave the reply")
        }
    ...
    return (
        ...
        <div className="w-full" style={{paddingLeft: `${leftVal*10}px`}}>
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-centre mt-5">
                    {
                ...
                <button className="underline" onClick={handelReply}>
                    Reply
                </button>
                {
                    username == commented_by_username || username == blog_author ?
                    <button className="p-2 px-3 rounded-md border border-grey ml-auto hover:bg-red/30 flex items-center"
