...
const publishBlog = (e) =>{
    ...
    if(!des.length||des.length>characterLimit){
        return toast.error(`Short description should be at most ${characterLimit} characters long`);
    }
    if(!tags.length){
    ...
    return(
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4  justify-center">
                <Toaster/>
                <button className="w-12 h-12 absolute right-[5vw] z-10 top-[5%] 
                lg:top-[10%]"
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <p className="text-dark-grey mb-2 mt-9">{characterLimit - des.length} character left</p>
                
                <p>
                    Topics-(Helps is searching and ranking your blog posts)
                </p>
                ...
                <button className="btn-dark  mt-14"
                type="submit"
                onClick={publishBlog}
                >
                    Publish
