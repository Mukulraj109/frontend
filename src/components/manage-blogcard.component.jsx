    ...
    <div className="flex gap-2 max-lg:mb-6 max-lg:pb-6 border-grey max-lg:border-b">
        {
            Object.keys(stats).map((info,i) =>{
                return !info.includes("parent") ? (
                    <div key={i} className={"flex  flex-col items-center w-full h-full p-4 justify-center p-4 px-6 " +(i != 0 ?"border-grey border-l" :"")}>
...
console.log(showStats);
    ...
    return (
        ...
        <img src= {banner} className="max-md:hidden lg:hidden xl:block h-28 w-28 flex-none object-cover"/>
